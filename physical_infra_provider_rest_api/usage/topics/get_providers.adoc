...
------------------------------------------------------------------------------------
* To retrieve information about only Lenovo physical-infrastructure providers, use the *?expand=resources&filter[]=type=<provider_type>* attribute on all provider resources, for example:
+
-----------------------------------------------------------------------------------------------------------------
